...
public class HomeController : Controller
{
    ...
    public IActionResult Privacy()
    {
        ...
        Cliente c1 = new Cliente(1, "Fernando", "456.123.789-45", "Fernando@email.com", "max");
        Cliente c2 = new Cliente(2, "Marques Fernando", "123.123.789-45", "Fernando@email.com", "teo");
